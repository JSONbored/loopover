...
describe("weekly value reports", () => {
  it("builds public-safe adoption and maintainer-value summaries from daily rollups", () => {
    const report = buildWeeklyValueReport({
      ...
      variant: "public",
      days: 7,
      repositories: [repo("JSONbored/loopover", true, true), repo("entrius/allways-ui", true, false)],
      ...
      usageRollups: [
        rollup("2026-05-30", {
          ...
          activeRepos: 2,
          repos: [
            { key: "JSONbored/loopover", count: 6 },
        ...
        rollup("2026-05-31", {
          ...
          activeActors: 2,
          activeRepos: 1,
          repos: [{ key: "JSONbored/loopover", count: 8 }],
          events: [
  ...
  it("adds operator details, freshness warnings, and redacts unsafe rollup dimensions", () => {
    const report = buildWeeklyValueReport({
      ...
      variant: "operator",
      days: 7,
      repositories: [repo("JSONbored/loopover", true, true)],
      installations: [installation(1)],
  ...
  it("keeps clean complete windows marked ready", () => {
    const report = buildWeeklyValueReport({
      ...
      upstreamDrift: upstream({ status: "current", openReportCount: 0 }),
      usageSummary: usageSummary({ totalEvents: 1, activeActors: 1 }),
      usageRollups: [rollup("2026-05-31", { totalEvents: 1, activeActors: 1, activeRepos: 1, repos: [{ key: "JSONbored/loopover", count: 1 }], events: [], surfaces: [], commands: [], tools: [] })],
      usageRollupStatus: rollupStatus({ status: "ready" }),
    });
