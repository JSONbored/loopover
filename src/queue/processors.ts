...
export async function maybeAddScreenshotTableAdvisoryFinding(
  ...
  try {
    ...
    /* v8 ignore next -- defensive: evaluateScreenshotTableGate only ever returns reason: null alongside violated: false, which the guard above already returned on, so this fallback is unreachable in practice. */
