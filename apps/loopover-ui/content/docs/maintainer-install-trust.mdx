...
description: A maintainer-first checklist for self-hosting and installing a GitHub App, keeping public output safe, authorizing commands, and rejecting weak LoopOver-driven PRs.
