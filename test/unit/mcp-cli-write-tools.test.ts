...
function spec(result: { structuredContent?: unknown }): { action: string; command: string; boundary: string } {
  return result.structuredContent as { action: string; command: string; boundary: string };
}
