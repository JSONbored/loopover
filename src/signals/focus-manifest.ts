...
export type FocusManifestReviewConfig = {
  ...
  /** `review.auto_merge_summary`: when true, the unified review comment gains a read-only collapsible table of
   *  which auto-merge conditions currently pass/fail (CI green, gate passing, mergeable-clean, valid linked
   *  issue). Surface only; does NOT change the merge/close DECISION. null/false (default, absent) = no table =
   *  byte-identical behavior. (#2051) */
